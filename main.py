...
insert_content("bof1.py",'prefix = "' + prefix + '"')
...
insert_content("bof2.py",'prefix = "' + prefix + '"')
...
insert_content("bof3.py",'prefix = "' + prefix + '"')
...
insert_content("bof4.py",'prefix = "' + prefix + '"')
